...
public class RequestFollowUser {
    ...
    public void followUser(Activity activity, final ErrorHandler handler, OkHttpClient httpClient,final int userId,final int followId,final String token){
        ...
        Request request=new Request.Builder()
                .post(formBody)
                .url(activity.getString(R.string.url_user)+userId+"/follow/"+followId)
                .build();
        Call call=httpClient.newCall(request);
        call.enqueue(new Callback() {
            @Override
            public void onFailure(Call call, IOException e) {
                handler.sendEmptyMessage(FANRequestCode.FOLLOW_USER_FAILURE);
            }
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                Log.i("TAG","ISinfOLLOW:"+str_response);
                ...
                try {
                    ...
                    //获取项目信息成功
                    handler.sendEmptyMessage(FANRequestCode.FOLLOW_USER_SUCCESS);
