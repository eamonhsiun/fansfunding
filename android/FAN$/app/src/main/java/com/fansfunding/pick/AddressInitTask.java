        ...
        if (result.size() > 0) {
            ...
            picker.setOnAddressPickListener(new AddressPicker.OnAddressPickListener() {
                ...
                public void onAddressPicked(AddressPicker.Province province, AddressPicker.City city, AddressPicker.County county) {
                    if (county==null){
                        Toast.makeText(activity, province.getAreaName() + city.getAreaName(), Toast.LENGTH_LONG).show();
                    } else {
                        Toast.makeText(activity, province.getAreaName() + city.getAreaName() + county.getAreaName(), Toast.LENGTH_LONG).show();
                    }
                }
