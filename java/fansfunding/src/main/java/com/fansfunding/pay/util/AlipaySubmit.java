...
import com.fansfunding.pay.sign.RSA;
...
public class AlipaySubmit {
	...
	public static String buildRequestMysign(Map<String, String> sPara) {
        ...
        if(AlipayConfig.signType.equals("RSA") ){
        	mysign = RSA.sign(prestr, AlipayConfig.privateKey, AlipayConfig.inputCharset);
        }
        return mysign;
    }
    /**
    ...
    public static Map<String, String> buildRequestParam(Map<String, String> sParaTemp) {
        ...
        sPara.put("sign_type", AlipayConfig.signType);
        return sPara;
    }
    /**
     * 建立请求，以表单HTML形式构造（默认）
    ...
    public static String buildRequest(Map<String, String> sParaTemp, String strMethod, String strButtonName) {
        ...
        sbHtml.append("<form id=\"alipaysubmit\" name=\"alipaysubmit\" action=\"" + ALIPAY_GATEWAY_NEW
                      + "_input_charset=" + AlipayConfig.inputCharset + "\" method=\"" + strMethod
                      + "\">");
    ...
    /**
     * 用于防钓鱼，调用接口queryTimestamp来获取时间戳的处理函数
	...
	public static String queryTimestamp() throws MalformedURLException,DocumentException, IOException {
        ...
        String strUrl = ALIPAY_GATEWAY_NEW + "service=query_timestamp&partner=" 
        		+ AlipayConfig.partner + "&_input_charset" +AlipayConfig.inputCharset;
